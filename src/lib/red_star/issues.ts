...
export const issues: RedStarIssue[] = [
	...
	},
	{
		...
		newsItems: [
			{
				href: 'https://www.thegardenisland.com/2025/09/26/business/kaiser-hawaii-workers-vote-to-authorize-a-strike/?TGI=15c87cf55b519def24616c0904ed0e7e2e6931fe',
				content:
					'3,000 Kaiser employees represented by UNITE HERE Local 5 and Hawaiʻi Nurses and Healthcare Professionals authorized a strike for fair wages on par with mainland counterparts and safe staffing ratios. Workers report burn out due to chronic understaffing, while Kaiser claims to be doing a good job at managing staffing ratios.',
				source: 'The Garden Island'
			},
			{
				href: 'https://www.hawaiinewsnow.com/2025/09/30/hawaii-army-set-framework-land-lease-negotiations/',
				content:
					'Collaborationist Josh Green and Secretary of the Army Dan Driscoll announced a non-binding “Statement of Principles” of land use in an attempt to push through land lease agreements between the US military and the state. Both parties are working towards a so-called mutually beneficial “Memorandum of Understanding” by the end of the year.',
				source: 'Hawaii News Now'
			},
			{
				href: 'https://www.civilbeat.org/2025/09/red-hill-victims-navy-destroyed-evidence/',
				content:
					'Lawyers for Red Hill victims are claiming that the US Navy withheld samples of contaminated water to prevent victims from using it as evidence in a lawsuit against the government. Last year’s trial resulted in a smaller payout than expected because the amount of fuel that reached people’s homes was “not capable of being reliably calculated”.',
				source: 'Civil Beat'
			},
			{
				href: 'https://www.hawaiinewsnow.com/2025/09/27/possible-recession-federal-cuts-could-have-outsize-effect-low-income-households/',
				content:
					'A UHERO report finds that tariff-fueled inflation is causing a slowdown in tourism. This crisis is compounded by the fact that state revenue is largely funded by a regressive GET tax as shown by a Hawaii Appleseed study. As human services is a large portion of the state budget, any tax revenue decreases will impact relief.',
				source: 'Hawaii News Now'
			},
			{
			...
			{
				href: 'https://www.guampdn.com/news/not-even-boiling-water-can-help-yigo-residents-share-worry-anxiety-confusion-over-dieldrin-contamination/article_68749be9-007d-4ab4-bca8-d977f76dd0f5.html',
				content:
					'In Guam, the pesticide Dieldren was detected at 3x the safe concentration in a well near Andersen Air Force Base, an American installation. The Guam Waterworks Authority irresponsibly suggests that residents of Yigo supplied by that well boil the water before consumption, which is insufficient and dangerous.',
				source: 'GuamPDN'
			}
		],
		editorial: {
			paragraphs: [
				'The military is giving us antibiotic-resistant gonorrhea (and other STIs)',
				'CW: sex work and trafficking, violence against women',
				'Hawaiʻi has one of the highest rates of antibiotic-resistant gonorrhea in the U.S., in no small part due to military personnel and tourism. Hawaiʻi was the first state to identify a strain of antibiotic-resistant gonorrhea in the US. Civilian and military populations are surveyed by the Honolulu and Tripler Army Medical Center (AMC) regional laboratories, respectively (1), although the data generated by them are lumped together in national reports (2). As such, it tends to be difficult to find hard numbers about antibiotic-resistant gonorrhea cases in the military, or any STI statistics really, but we can make some assumptions.',
				"The army admits that the rates of gonorrhea, chlamydia, and HPV among the military in Hawaiʻi is higher than the national military average, and several times higher than the national average (3,4). A 2018 Department of Defense (DoD) survey of active duty military personnel revealed that a fifth have had more than two sexual partners in the last year, and over a third had sex without protection with a new partner within the past year (5). STI rates increase when military personnel return from deployment, leave, and even long holiday weekends (3). It's not a great leap in logic to conclude that antibiotic-resistant strains of these infections are being spread by the military members treating Hawaiʻi like their personal playground.",
				"Military personnel tend to wait until symptoms appear before getting help, which is a problem when the most common symptom of an STI is no symptoms at all. Coupled with the fact that the DoD doesn't require annual STI screening for men (6), strains of gonorrhea that failed to respond to treatments were identified overseas (7), and the RIMPAC military exercises are next year? There's an antibiotic-resistant powder keg waiting to explode in Hawaiʻi.",
				`The spread of STIs is yet another facet of the violence perpetuated by the military on Hawaiʻi. The government of Hawaiʻi acknowledges that the military enacts violence against women and girls, and RIMPAC exacerbates it even more (8). An Arizona State University study revealed that Hawaiʻi has an "astronomical" demand for sex work compared to other states, and a large number of buyers are from military bases (9). The military fails to confront violence against women by active-duty members, to say nothing of the fact that a disproportionate amount of sex trafficking survivors in Hawaiʻi are Native Hawaiian (10).`,
				"So what are we left with? The military doesn't care about stopping the spread of STIs, only that they aren't impacting their ability to desecrate Hawaiʻi. If you're on the dating apps you know that they're crawling with military personnel, and it seems like if they can't get sex through apps they buy it. They're not getting diagnosed, they're having unprotected sex with multiple partners, and they're spreading antibiotic-resistant STIs. Untreated (or untreatable) STIs can lead to infertility, chronic pain, pregnancy complications, increased risk of HIV infection, and death.",
				'Hawaiʻi is occupied by 250,000 military personnel. Do not have sex with them.',
				'',
				'(1) "Gonococcal Isolate Surveillance Project (GISP) Profiles", 2025. Center for Disease Control. https://www.cdc.gov/sti-statistics/gisp-profiles/',
				'(2) "STI surveillance" Table 20. 2024. Center for Disease Control. https://www.cdc.gov/sti-statistics/data-vis/table-gc-state-abc.html',
				'(3) Bass L. 2015. Walk-in STI clinic provides confidentiality screenings, testing, education. U.S. Army. https://www.army.mil/article/150462/walk_in_sti_clinic_provides_confidentiality_screenings_testing_education',
				'(4) "Sexually Transmitted Infections Among Active Component Members of the U.S. Armed Forces, 2015-2023". 2024. Military Health System. https://www.health.mil/News/Articles/2024/06/01/MSMR-STIs-2023?type=Fact+Sheets',
				'(5) Meadows SO, Engel CC, Collins RL, Beckman RL, Breslau J, Bloom EL, Dunbar MS, Gilbert M, Grant D, Hawes-Dawson J. 2021. 2018 Department of Defense Health Related Behaviors Survey (HRBS). RAND Corporation. https://www.rand.org/pubs/research_reports/RR4222.html',
				'(6) Hauschild V. 2024. Show You Care, Protect Yourself, Others from STIs. U.S. Army. https://www.army.mil/article/275401/show_you_care_protect_yourself_others_from_stis)',
				'(7) Katz AR, Komeya AY, Dewater JM, Tomas JE, Chinna L, Wasserman GM. 2020. Emerging Trends in Antibiotic Resistant Neisseria gonorrhoeae: A National and Hawai‘i Perspective. Hawaii J Health Soc Welf: 79(3):68-70. https://pmc.ncbi.nlm.nih.gov/articles/PMC7061027/',
				'(8) "Hawaii State Commission on the Status of Women launches anti-trafficking campaign". 2018. Department of Human Services. https://humanservices.hawaii.gov/hawaii-state-commission-on-the-status-of-women-launches-anti-trafficking-campaign/.',
				'(9) Roe-Sepowitz D & Jabola-Carolus K. 2018. Sex Trafficking in Hawaiʻi Part 1: Exploring Online Sex Buyers. Arizona State University. https://humanservices.hawaii.gov/wp-content/uploads/2018/09/Demand-Study-Part-1-Sex-Trafficking-Research-in-Hawaii-FINAL-DESIGNED-090718.pdf',
				'(10) Farfan I. 2023. Lawmakers, advocates call on military to do more to address violence against Native Hawaiian women. Hawaii News Now. https://www.hawaiinewsnow.com/2023/11/03/lawmakers-advocates-call-military-do-more-address-violence-against-native-hawaiian-women/'
			],
			author: '1/2 lb wasabi salmon poke'
		},
		events: [
			{
				when: ['Every Sunday', '5pm @ Thomas Square'],
			...
			{
				when: ['Saturday, Oct 4', '4pm @ Stadium Park'],
			...
			},
			{
				...
				title: ['Democratic Socialists of Hawai’i Meeting']
			},
			{
				when: ['Sunday, Nov 2', '1pm @ Old Stadium Park'],
				title: ['Honolulu Tenant’s Union [HoTU] Mōʻiliʻili']
			}
		]
	},
	{
	...
	},
	{
		...
		newsItems: [
			{
				href: 'https://spectrumlocalnews.com/hi/hawaii/news/2025/08/25/army-secretary-writes-to-green-regarding-lease-renewals',
				content:
					'Gov. Josh Green intends on collaborating with the Army on new land leases, after the final EIS for the current leases was rejected by BLNR. Green seeks the return of Mākua Valley and the cleanup of training areas, fearing that the federal government will use eminent domain to seize lands if no agreement is reached.',
				source: 'Spectrum Local News'
			},
			{
				href: 'https://www.hawaiinewsnow.com/2025/08/30/federal-grand-jury-indicts-two-civilian-workers-over-red-hill-disaster/',
				content:
					'Two civilian workers for the Navy have been indicted for the Red Hill fuel spill for covering up the true magnitude of the spill. Some question why only two are being held responsible, pointing to the fact that Navy officials did not publicly say anything about the spill until hundreds were sick.',
				source: 'Hawaii News Now'
			},
			{
				href: 'https://www.theguardian.com/world/2025/sep/02/indonesia-protests-explained-start-how-has-the-government-responded',
				content:
					'Thousands in Indonesia have been protesting against militarism, austerity, and corruption. The government detained more than 1,240 protesters and seven people have died.',
				source: 'The Guardian'
			},
			{
				href: 'https://www.hawaiinewsnow.com/2025/08/27/army-battles-brush-fire-schofield-barracks/',
				content:
					'The US Army started a brush fire at Schofield Barracks that burned 250 acres of land. Heat from a full-range training round ignited a patch of guinea grass that began the fire.',
				source: 'Hawaii News Now'
			},
			{
				href: 'https://thecommunists.org/2025/08/29/news/venezuelan-masses-respond-usa-invasion-threats/',
				content:
					'The American Empire is escalating its harassment of Venezuela through both smear campaigns and Naval mobilization- in addition to the ongoing economic oppression of "sanctions." The working people of Venezuela are unflinching and reaffirm their commitment to their kinfolk.',
				source: 'CPGB'
			},
			{
				href: 'https://english.news.cn/asiapacific/20250816/fb95e72559d74addb1177a6f1d82678f/c.html',
				content:
					'A China-aided landmine elimination project cleared over 160 sq km of land contaminated with unexploded ordinance (UXO) in Cambodia. From 1965 to 1973, the United States had dropped over 2.75 million tons of ordinance in Cambodia, leaving behind an estimated 4 million to 6 million landmines that killed 19,843 and maimed 45,267 since 1979.',
				source: 'Xinhua'
			}
		],
		editorial: {
			paragraphs: [
				'No New Lease',
				'In the context of American imperialism in the late 19th century and especially under the tyranny of martial law in WWII, the U.S Military seized countless acres of unceded Private Hawaiian National/Government land.',
				'Some thousands of that stolen acreage were “legitimized” into 65 year leases in 1964. Approximately 6,322 on Oʻahu and 23,000 acres on Hawaiʻi Island were “leased”, some for the price of $1.',
				`Set to expire in 2029, the Military has made public their delusions of “Retention” of these leases. Environmental Impact Statements concerning the Pōhakuloa Training Area (Hawaiʻi Island) and Oʻahu (Poamoho, Mākua, Kahuku) Leases have both failed, and with them, a major setback has been dealt to the Military's intentions to "retain" that land.`,
				'And still yet! Secretary of the Army, Daniel Driscol, sent Governor Josh Green a letter citing their intention to create an "acceptable [...] framework by the end of the year."',
				'This is HEWA! Already, a growing coalition of Hawaiian Organizations are impressing the power of the people upon him, reminding: the occupation will not continue!',
				'Kānaka ʻŌiwi and workers of Hawaiʻi have resisted American militarization of their Nation as long as the U.S. has been in Hawaiʻi. In 1837 Hawaiian historian David Malo forewarned the nature of “powerful countries” to prey upon the weak. As American military presence grew, so did Hawaiian resistance.',
				'Hawaiʻi was the first stone laid in the bloody construction of the American Pacific Empire. At the time of the overthrow of the Hawaiian Kingdom, not only did our Revolutionary, Robert Wilcox fight Capitalist-American interest in Hawaiʻi, he expressed heartfelt solidarity with the Filipino people. In the following decade, hundreds of thousands of Filipinos would be massacred, starved, and placed into concentration camps by occupying American forces in the Philippine-American War.',
				`Following Wilcox's struggle in 1895, working people have staged occupations and protests throughout the 20th and 21st centuries, demanding their right to work and honor their land. Notably, the Puʻuhonua o Mākua tout an eviction struggle against the state in 1995-96.`,
				`We inherit an increasingly turbulent geopolitical situation. The declining United States continues to use Hawaiʻi'as a launch pad and vacation stop for aircraft carriers coming from and going to the Middle East to support Israeli genocide. Our islands and especially during the RIMPAC war games, serve as venue for cooperation between American Police, the genocidal Israeli Occupation Forces, and other former forces of Genocide. Additionally, the U.S. seeks to retain control of the Pacific as a means of provoking war with China. It is high time for us, people of Hawaiʻi, to get the big red target off our back: as long as the United States is in Hawaiʻi, they represent danger to us and the working people of the world.`,
				'It is time for the movement in Hawaiʻi to align with the global masses. Our safety is in struggle for a new Nation, against the Imperialist pigs in D.C. and in Solidarity with the masses in Palestine, the Phillippines, Guåhan, Palau and everywhere the unhinged capitalist class drives the U.S. War Machine.',
				'As this struggle takes form, it is imperative that we both take heed of the spontaneous pressure on the military and get Organized into bodies capable of securing these lands and their cleanup! No New Lease!'
			],
			author: 'anonymous'
		},
		events: [
			...
			{
				when: ['Sunday, Sept 2', '1pm @ Old Stadium Park'],
				title: ['Honolulu Tenants Union [HoTU] Mōʻiliʻili Local Potluck & Meeting']
			},
			{
				when: ['Sunday, Sept 14', '3pm'],
				title: ['Democratic Socialists of Oʻahu [DSO] General Meeting']
			},
			{
				when: ['Saturday, Sept 20', 'by sign-up'],
				title: ['DSO Book Club']
			}
		]
	},
	...
	},
	{
		...
		editorial: {
			paragraphs: [
				"For four hours on Wednesday, I felt like I was on the frontlines of an emergency. Throughout the afternoon and evening of July 30, I was working my regular eight hour shift at a grocery store with, suddenly, the added element of impending natural disaster. One moment, my coworker from Mākaha was finishing her shift and saying “I've got to get home,” after the first interval of alarms. Next, I was in charge of twenty-plus people at a time using the self check-out registers while two lines of thirty or more customers waited for the three stations on either side.",
				"When the alert first buzzed on my phone, I felt a wave of anxiety remembering the notable warnings we'd received on Oʻahu in the past; in 2018, a message reading that a nuclear missile was heading straight towards us, and before then the various tsunami warnings that I'd evacuated from with my family as a child. At around 3:30 PM, a tourist family from Spain pulled me aside to ask, “Is this normal here? Should we be scared?”. I told them that it wasn't, and asked where they were staying, which was in Waikīkī. The store I work in is in the Waikīkī ahupuaʻa of Kona, north enough that we were out of the evacuation zone. Soon after, the store was flooded with more people than I had ever seen before. Most were buying water and ice, but others had carts full of groceries. Customers sent me on errands to collect expensive liquor out of the cabinet and get them cigarettes, and joined the massive lines. Oddly enough, through the constant movement, I observed people being more patient than I'd ever seen them. We all seemed to accept what was going on– everyone equally had somewhere they would rather be. I operated with mounting panic and urgency, but also a sense of responsibility for the people there.",
				"Two additional managers had been called in to assist, with one regular cashier and five managers manning the front. I asked if we were going to close, something that had seemed inevitable as I tried to picture possibly working through an impending tsunami. When they said no, I thought resentfully of the cut hours, low budget, and decreased sales that the past few months have brought on. My heart crumpled a little as I tried to imagine having to do my other duties and beginning the lengthy process of balancing the store's books after spending the evening managing the crisis. One thing from the response was clear– the tsunami was good for business.",
				"After a mandated lunch period spent texting friends and family frantically and as we got closer to when the waves were supposed to hit, there were fewer people anxiously buying. Things changed over the next few hours in a way that shocked me. A haole college student, flashing me his ID as he bought drinks, politely asked how my day was going shortly after 7pm– I froze, not knowing what to say. Another haole man with an Australian accent joked “just one of those nights?” when I didn't respond to the same question a while later. Tourists had evacuated to the nearby park and the shopping center my store was in and filled the parking lot with their families and suitcases. The single stall public bathroom offered by our store had a winding line long into the evening. The cognitive dissonance wasn't exclusive to the tourists; an older couple, regular customers, approached me to ask if anything was going on, other than the tsunami. Meanwhile, I answered twenty identical phone calls as the night grew longer, and began to dread picking up the phone to people asking if we were staying open. All I wanted was to go home. During the rush as we awaited disaster, I hadn't really been upset by any of the grating interactions commonplace to high-stress situations and customer service work in general. In the aftermath, people's nonchalance confused and hurt me.",
				"In the next few days, the emotional divide occurring was stark. The next day was back to business as usual, and I was the one bringing it up in conversations. Speaking with family members, friends and coworkers, I heard about the time and energy people spent trying to get home. Coworkers and their families had also evacuated to the district park for the night. My coworker had told her adult niece and nephew, who were crying over the phone, to get to shelter without her so she could collect their pets. My aunty spent two hours in what would've been a fifteen minute drive trying to get to her daughter's workplace; other people abandoned their cars and started walking. Traffic was made worse by tourists trying to leave Waikīkī instead of sheltering in their hotels as advised and cruise ship guests who were transported by shuttle to shelters. If there were shuttles and buses ready to take residents rather than tourists to safety, much of the traffic jam could have been avoided. Additionally, most were told to leave work once the tsunami warning was issued no matter where they lived, but many service workers were not allowed to leave or were released long after the first warnings. 7-Elevens within the evacuation zone had lines out the door. Service workers, who are often treated the worst and paid the least, are expected to sacrifice their safety for profit during natural disasters. Worse was later learning that those who did stay in hotels were cheering when the waves were supposed to arrive, while complaining online that food service was suspended because the hotel workers were allowed to leave. They don't see service workers as people with families and lives, they only see their missed dinner and ruined vacation.",
				'It feels like an incredible miracle that people were safe, especially in the age of the climate crisis and resulting catastrophes that disproportionately affect marginalized populations, especially Native and working class people.  We must recognize that the capitalist, tourist economy prioritizes haole during emergencies and expects residents to make sacrifices for their comfort. I would gladly serve my community in a moment like this again, but am struggling in an aftermath that neglects the emergencies we have faced and that are to come.'
			],
			author: 'Anonymous'
		},
		events: [
